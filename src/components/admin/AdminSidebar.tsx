...
export const AdminSidebar = ({ isOpen, onClose, activeTab = "dashboard", onTabChange }: AdminSidebarProps) => {
  const menuItems = [
    ...
    { id: "thirdparty", icon: Globe, label: "Aplicativo de terceiros", hasSubmenu: true },
    ...
    { id: "delivery", icon: Utensils, label: "Delivery Management", hasSubmenu: true },
    ...
    { id: "multicurrency", icon: Globe, label: "Multi Currency", hasSubmenu: true },
    { id: "digitalwallet", icon: Wallet, label: "Digital Wallet", hasSubmenu: true },
    ...
    { id: "commercial", icon: Store, label: "Comercial", hasSubmenu: true },
